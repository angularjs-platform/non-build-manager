...
You can read more about Scopes:
...
Angular allows the controller to interact with the view through the scope object. While this is a clean separation, it’s also pretty easy to make the scope object very messy. There are two general guidelines to stick to with regards to the scope:
  ...
  - **the scope should be write-only in controllers**

  - **the scope should be read-only in views** (templates)
  
In other words, you send data to the view by writing to the scope in the controller and in the view (template) you can only read from the scope. If something needs to be communicated back to the controller, you should do it through an action.
You can learn more about this:
  
  - [http://jacopretorius.net/2013/07/angularjs-best-practices.html](http://jacopretorius.net/2013/07/angularjs-best-practices.html)
  
  - [https://www.thoughtworks.com/insights/blog/good-practices-build-your-angularjs-application#Scope](https://www.thoughtworks.com/insights/blog/good-practices-build-your-angularjs-application#Scope)
  
  - [AngularJS MTV Meetup: Best Practices (2012/12/11)](https://youtu.be/ZhfUv0spHCY?t=29m19s)
